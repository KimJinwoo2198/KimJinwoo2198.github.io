...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 300">
  ...
  <g transform="translate(0, 0)">
    ...
    <text x="150" y="200" font-size="16">최대 힙</text>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
  ...
  <!-- Insert Operation -->
  <g transform="translate(0, 0)">
    <text x="200" y="20" font-size="16" font-weight="bold">삽입 연산</text>
    ...
    <g transform="translate(0, 50)">
      ...
      <text x="175" y="150">0</text>

      <text x="100" y="200">1. 새 원소를 마지막에 추가</text>
    </g>
...
이 그림에서 볼 수 있듯이, 삽입 연산은 새로운 원소를 아래에서 위로 올리는 과정이고, 삭제 연산은 마지막 원소를 위에서 아래로 내리는 과정입니다.
